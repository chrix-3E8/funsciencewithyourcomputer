...
public class SpaceSimulation1 {

	public static void main(String[] args) throws Exception {
		final SpaceSimulation1 simulation = new SpaceSimulation1();
		simulation.create();
	...
	public void create() {
		...
		planet1.x = 2 * width / 3;
		planet1.y = 2 * width / 3;
		planet1.radius = width / 30;
		planet1.mass = 10E12;
		planet1.vx = 10;
		planet1.vy = 0;
		planet1.thrust = 0;
		planet1.thrustAngle = 0;
		...
		planet2.x = width / 3;
		planet2.y = width / 3;
		planet2.radius = width / 30;
		planet2.mass = 10E12;
		planet2.vx = -10;
		planet2.vy = 0;
		planet2.thrust = 0;
		planet2.thrustAngle = 0;
	...
	public static class Screen extends Frame {
		...
		SpaceSimulation1 simulation;

		public Screen(final SpaceSimulation1 simulation) {
