...
public class SpaceSimulation4 {

	public static void main(String[] args) throws Exception {
		final SpaceSimulation4 simulation = new SpaceSimulation4();
		simulation.create();
		Screen screen = new Screen(simulation);
		screen.setVisible(true);
		long displayDelayMilliseconds = 1000;
	...
	public static class Screen extends Frame {
		...
		SpaceSimulation4 simulation;

		public Screen(final SpaceSimulation4 simulation) {
